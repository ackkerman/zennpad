...
import { ZennTreeDataProvider, SortOrder } from "../zennTreeDataProvider";
...
export function registerCommands(context: vscode.ExtensionContext, deps: CommandDeps): void {
  const { fsProvider, treeDataProvider, scheme, previewWorkspace, previewManager, githubSync, statusBarItem } =
    deps;
